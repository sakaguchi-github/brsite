				...
				<div style="margin-left: 1em; margin-top: 7em">
					<s:form action="BookSearchAction">
						<div class="form-group row">
							<div class="text-dark">
								<select class="bg-white custom-select" name="bookType"
									style="width: 10em">
							...
							<div class="btn-group ml-2">
								<input type="text" class="form-control mr-2" name="keywords"
									style="width: 20em" placeholder="本のタイトル、著者・共著者名、出版社名など">
