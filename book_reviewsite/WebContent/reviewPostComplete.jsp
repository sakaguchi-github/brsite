							...
							<div class="col-12 mt-3 text-center">
								<s:form>
									<input type="button" class="mb-3 btn btn-secondary d-inline-block"
										value="投稿したレビューを確認する" onclick="submitAction('ReviewDetailAction')"><s:param name="id" value="#session.id" />
								</s:form>

								<s:form>
									<input type="button" class="mt-3 btn btn-success d-inline-block"
										value="続けて他の本もレビューする" onclick="submitAction('Menu_ReviewPostAction')">
